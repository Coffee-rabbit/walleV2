...
class GradlePlugin implements org.gradle.api.Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        if (version != null && versionCompare(version, "2.3.0") < 0) {
            throw new ProjectConfigurationException("Plugin requires the 'com.android.tools.build:gradle' version 2.3.0 or above to be configured.", null);
        }
